...
public class MainWindow extends Application {
    ...
    protected static ComboBox<String> combo2 = new ComboBox<String>();
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        helpButton.setOnMouseClicked(new javafx.event.EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                try {
                    sample.HelpInformation.start(primaryStage, gridPane);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
        ...
        /**
         * @field okButton if the OK button is clicked
         * @class  OkButtonHandle checking if all or some of the input data is null or not
         */
...
//        }else if (test1.isSelected()) {
//            System.out.println(test2.getText());
//        }
//        System.out.println(date.getValue()); // το επιστρεφει με μορφη year/month/day
//        if (pas.isSelected()) {
